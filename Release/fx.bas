...
Option Explicit
    ...
    Public Declare Function fxEllipse Lib "fx.dll" (ByVal DC As Long, ByVal Left As Long, ByVal Top As Long, ByVal Right As Long, ByVal Bottom As Long, ByVal Border As Long, ByVal Fill As Long) As Long
